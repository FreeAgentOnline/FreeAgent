...
class Home extends Component {
  ...
  render() {
    ...
    return (
      <div id="home">
          <header id="homeHeader" className="container-fluid justify-content-between align-items-center">
        ...
        <main className="container">
            <div id="homeTop" className="row homerow">
              <div id="scheduleImg" className="col col-md-8">.col .col-md-8</div>
              <div id="scheduleInfo" className="col-6 col-md-4">.col-6 .col-md-4</div>
            </div>
            <div id="homeMiddle" className="row homerow">
              <div id="profileInfo" className="col-6 col-md-4">.col-6 .col-md-4</div>
              <div id="raceStart" className="col col-md-8">.col .col-md-8</div>
            </div>
            <div id="homeBottom" className="row homerow">
              <div id="MoUsain" className="col col-md-8">.col .col-md-8</div>
              <div id="searchMeetsInfo" className="col-6 col-md-4">.col-6 .col-md-4</div>
            </div>
        </main>
